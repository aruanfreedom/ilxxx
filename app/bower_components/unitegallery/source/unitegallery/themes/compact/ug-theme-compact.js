...
function UGTheme_compact(){
	...
	//theme options
	var g_options = {
			theme_load_slider:false,					//true, false - load the slider
			theme_load_panel:false,					//true, false - load the thumbs grid panel
			theme_panel_position: "left",			//top, bottom, left, right - thumbs panel position
			theme_hide_panel_under_width: 1200		//hide panel under certain browser width, if null, don't hide
	};
